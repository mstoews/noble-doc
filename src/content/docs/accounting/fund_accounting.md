...
<!-- IMAGE PLACEHOLDER: diagram-operating-vs-reserve-funds.png — Diagram showing operating and reserve funds as two separate buckets. -->

## What is Fund Accounting?

Fund accounting is a method of tracking money by purpose rather than just by account. Instead of one big pool of cash, your finances are organized into separate funds — each with its own budget, its own rules, and its own reporting.
...
QuickBooks, Sage, and similar tools are designed around a single set of books. You can create workarounds — separate accounts, classes, or departments — but they're exactly that: workarounds. They require extra setup, extra discipline, and extra knowledge to maintain.
...
- Your financial statements reflect the true picture of each fund separately
...
Many condo boards don't realize their finances are being managed without proper fund accounting until something goes wrong — a special assessment that shouldn't have been necessary, an audit that takes twice as long as it should, or a reserve fund that turns out to be underfunded.
